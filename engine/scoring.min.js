...
this.elements.dailyProgress.style.width=`${Math.min(
      dailyPercent,
      100
    )}%`;this.elements.todayExecution.textContent=`${Math.round(dailyPercent)}%`;if(!this.state.scores.dailyHistory){this.state.scores.dailyHistory={};}
