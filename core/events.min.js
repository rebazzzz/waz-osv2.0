...
export function updateTime(){const now=new Date();this.elements.currentTime.textContent=`${now
    .getHours()
    .toString()
    .padStart(2, "0")}:${now.getMinutes().toString().padStart(2, "0")}`;const days=["SUNDAY","MONDAY","TUESDAY","WEDNESDAY","THURSDAY","FRIDAY","SATURDAY",];this.elements.currentDay.textContent=days[now.getDay()];}
